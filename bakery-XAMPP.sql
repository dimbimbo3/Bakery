...
drop database if exists imbimbd2_bakeryDatabase;
create database imbimbd2_bakeryDatabase;
use imbimbd2_bakeryDatabase;
...
-- Create a user named bakery with password as bakerypass
GRANT SELECT, INSERT, DELETE, UPDATE
ON imbimbd2_bakeryDatabase.*
TO imbimbd2_user1@localhost
IDENTIFIED BY 'passwordtest123';